...
export default function TenancyModificationAlert({
    data,
    hide,
    buttonLabel,
    buttonVariant,
    ...
    const { refetch }: any = useQuery({ queryKey: ['property-tenancy-modifications', token, property, page], queryFn: () => fetchTenancyModifications(token, property, page, "") })

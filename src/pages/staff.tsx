...
export default function Staff({
    ...
    return (
        <>
            <Typography color="black" fontSize="1.5rem" fontWeight="600">Staff</Typography>

            <StaffTable property={propertyId} />
            <StaffForm property={propertyId} />
        </>
    )
}
...
export const getServerSideProps: GetServerSideProps<PageProps> = async context => {
    ...
    await queryClient.prefetchQuery(['property-staff'], () => fetchStaff(propertyId, 1, "", ""))
